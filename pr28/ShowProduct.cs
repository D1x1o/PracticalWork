...
namespace pr28
{
    public partial class ShowProduct : Form
    {
        ...
        int currentPage = 0;      // текущая страница (начинаем с 0)
        int totalRows = 0;        // общее количество записей

        public ShowProduct()
        {
            InitializeComponent();
            CountTotalRows();     // сначала узнаём сколько всего строк
            FillDGV();            // грузим первую страницу
        }
